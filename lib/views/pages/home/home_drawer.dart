...
class HomeDrawer extends StatelessWidget {
  ...
  Widget _buildChild(BuildContext context) => Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            _buildItem(context, TolyIcon.icon_them, '应用设置', Routers.setting),
            ...
            Divider(height: 1),
            _buildItem(context, Icons.info, '关于应用', Routers.about_app),
            _buildItem(context, TolyIcon.icon_kafei, '联系本王', Routers.about_me),
          ],
        ),
      );
  ...
  Widget _buildFlutterUnit(BuildContext context) => NoBorderExpansionTile(
        ...
        children: <Widget>[
          _buildItem(context, TolyIcon.icon_tag, '属性集录', Routers.attr),
          _buildItem(context, Icons.palette, '绘画集录', Routers.paint),
          _buildItem(context, Icons.widgets, '布局集录', Routers.layout),
          _buildItem(context, TolyIcon.icon_bug, '要点集录', Routers.bug),
        ],
      );
